...
const alphabets=[
    ...
    {id:2, alpha:"B",name:"Ball"},
    {id:3, alpha:"C",name:"Cat"},
    {id:4, alpha:"D",name:"Dog"},
    {id:5, alpha:"E",name:"Elephant"},
    {id:6, alpha:"F",name:"Fish"},
    {id:7, alpha:"G",name:"Grass"},
    {id:8, alpha:"H",name:"Hen"},
    {id:9, alpha:"I",name:"Ice Cream"},
    {id:10, alpha:"J",name:"Joker"},
    {id:11, alpha:"K",name:"Kite"},
    {id:12, alpha:"L",name:"Lollipop"},
    {id:13, alpha:"M",name:"Mango"},
    {id:14, alpha:"N",name:"Nest"},
    {id:15, alpha:"O",name:"Orange"},
    {id:16, alpha:"P",name:"Peacock"},
    {id:17, alpha:"Q",name:"Queen"},
    {id:18, alpha:"R",name:"Rat"},
    {id:19, alpha:"S",name:"Snake"},
    {id:20, alpha:"T",name:"Tiger"},
    {id:18, alpha:"U",name:"Umberalla"},
    {id:19, alpha:"V",name:"Van"},
    {id:20, alpha:"W",name:"Watch"},
    {id:21, alpha:"X",name:"X-mas"},
    {id:22, alpha:"Y",name:"Yak"},
    {id:23, alpha:"Z",name:"Zebra"},
];
...
const images=[
    ...
    {id:22,image_link:"https://i.dlpng.com/static/png/6924246_preview.png"},
